...
class PDF(FPDF):
    def header(self):
        # logo
        self.image('btf_logo.png', 7, 22, 30)
        self.image('btf_logo.png', 178, 22, 30)
        # font
        self.set_font('helvetica', 'B', 25)
        # Fill
        self.set_fill_color(255, 140, 0)
        self.set_text_color(255,255,255)
        self.cell(0, 10, 'INVOICE', ln=1, align='C', fill=1)
        self.ln(40)
    
    def footer(self):
        self.set_font('helvetica', 'I', 9)
        self.set_text_color(0,0,0)
        self.text(99, 269, f'Page {self.page_no()}/{{nb}}')
        self.image('btf_guild_logo.png', 75, 257, 15)
        self.image('btf_guild_logo.png', 118, 257, 15)
